...
test-unit:
	...
	docker run --name unit-tests2 --env PYTHONPATH=/opt/calc -w /opt/calc -v $(pwd):/opt/calc/results calculator-app:latest junit2html /opt/calc/results/unit_result.xml /opt/calc/results/unit_result.html
