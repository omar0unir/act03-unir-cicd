...
test-api:
	...
	docker run --network calc-test-api --name api-tests --env PYTHONPATH=/opt/calc -w /opt/calc calculator-app:latest junit2html results/api_result.xml results/api_result.html
