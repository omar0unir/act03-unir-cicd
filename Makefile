...
test-unit:
	...
	docker run --rm --volume `pwd`:/opt/calc/results --env PYTHONPATH=/opt/calc -w /opt/calc calculator-app:latest junit2html results/unit_result.xml results/unit_result.html -v
